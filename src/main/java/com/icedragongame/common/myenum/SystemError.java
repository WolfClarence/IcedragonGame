...
public enum SystemError {
    ...
    DATABASE_ERROR(501,"数据库错误"), USER_NOT_FOUND(502, "用户未找到"),
    USER_HAS_BEEN_FREEDOM(503, "该用户已处在解封态"),
    POST_NOT_FOUND(504, "文章未找到"),
    USER_HAS_BEEN_ADMIN(505,"该用户已是管理员" ),
    USER_HAS_BEEN_BANNED(506, "用户已经被封禁"), WRONG_FORMAT_FOR_POST_STATUS(507, "错误的文章状态格式"),
    POST_HAS_BEEN_STATUS(508, "该文章已在该状态"), USER_HAS_BEEN_EXIST(509, "用户已存在"),
    NICKNAME_HAS_BEEN_EXIST(510, "昵称已被占用"), NO_THIS_CATEGORY(511, "无此游戏类别"),
